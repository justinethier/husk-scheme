...
- Added support for Parameter Objects (SRFI 39). See [dynamic bindings]((http://justinethier.github.io/husk-scheme/manual/node41.html) in the user manual for more information.
